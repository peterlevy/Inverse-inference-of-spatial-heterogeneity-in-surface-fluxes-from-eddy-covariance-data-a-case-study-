...
In contrast to the above equation, eddy covariance (EC) does not measure the flux over a rectangular gridded landscape. EC-measurements represent a non-rectang but over the footprint area, with unequal contributions from different locations in that area as represented by the footprint function f(s), which integrates to unity.
