...
In contrast to the above equation, eddy covariance does not measure the flux over a rectangular gridded landscape, but over the footprint area, with unequal contributions from different locations in that area
